...
<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
    <div class="text-center">
        <!--- <div class="author-img" style="background-image: url(view/assets/images/about.jpg);"></div> --->
        <h1 id="colorlib-logo" style="text-align:center;">PHP Patterns</h1>
        <span class="position"><a href="#">Паттерны </a> программирования</span>
    </div>
    <nav id="colorlib-main-menu" role="navigation" class="navbar">
        <div id="navbar" class="collapse">
            <ul>
                ...
                <li><a href="#" data-nav-section="factory">Factory</a></li>
...
<div id="colorlib-main">
    ...
    <section class="colorlib-about" data-section="factory">
                    ...
                    <div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                        <div class="col-md-12">
                            <div class="about-desc">
                                <span class="heading-meta">Factory</span>
                                <h2 class="colorlib-heading">Фабричный метод</h2>
                                <p><strong>Фабричный метод</strong>— это порождающий паттерн проектирования,
